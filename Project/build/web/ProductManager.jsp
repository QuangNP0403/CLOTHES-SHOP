...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h2><a href="listproduct">Check Out Control</a></h2>
            ...
            <table>
                ...
                <c:forEach items="${ListP}" var="i">
                    <c:set var="id" value="${i.product_id}"/>
                    <tr>
                        <td>${id}</td>
                        ...
                        <td class="action-links">
                            <a href="update?productId=${i.product_id}" class="update-btn">Update</a>
                            <a href="delete?productId=${i.product_id}" class="delete-btn">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
