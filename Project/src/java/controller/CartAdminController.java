 ...
 * @author Quang
 */
@WebServlet(name = "CartAdminController", urlPatterns = {"/cartadmin"})
public class CartAdminController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Lấy thông tin sản phẩm theo userID và thời gian mới nhất
        Vector<CheckOut> vectorCO = daoCheckOut.getAllByCheckOut(sqlQuery, userId);
        ...
        request.getRequestDispatcher("cartadmin.jsp").forward(request, response);
    }
